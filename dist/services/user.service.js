...
class UserService {
    ...
    updateUser(username, update) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield user_model_1.default.findOneAndUpdate({ username: username }, update, { new: true });
        });
    }
    // Delete user
    deleteUser(username) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield user_model_1.default.findOneAndDelete({ username: username });
        });
    }
    // Fetch one user
    fetchOne(filter) {
